      ...
      <Container>
        <div className="flex flex-col items-center justify-center gap-8">
          ...
          <div className="flex gap-6">
            <a
              href="https://www.instagram.com/ladongnyc/"
              target="_blank"
              rel="noreferrer"
              className="w-12 h-12 rounded-full bg-white/90 hover:bg-white flex items-center justify-center transition-all transform hover:scale-110"
              aria-label="Instagram"
            >
              <svg className="w-6 h-6 text-ladong-red" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a
              href="https://www.facebook.com/ladongnyc/"
              target="_blank"
              rel="noreferrer"
              className="w-12 h-12 rounded-full bg-white/90 hover:bg-white flex items-center justify-center transition-all transform hover:scale-110"
              aria-label="Facebook"
